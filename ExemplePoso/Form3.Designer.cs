namespace ExemplePoso
{
    partial class Form3
    {
        ...
        private void InitializeComponent()
        {
			...
			this.button1.Text = "Vidal Expert";
			...
			this.button2.Text = "Web Services";
			...
			this.button4.Text = "Ouvrir Vidal Expert";
			...
			this.labelVersion.Location = new System.Drawing.Point(101, 158);
			...
			this.vxpPath.Location = new System.Drawing.Point(101, 176);
			...
			this.label3.Text = "S\'interfacer avec...";
			// 
			// Form3
			// 
